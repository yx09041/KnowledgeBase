...
namespace MyWeb
{
    ...
    public class HandlerErrorAttribute : HandleErrorAttribute
    {
        ...
        {
            bool ErrorToMail = Mysoft.Util.Config.GetValue("ErrorToMail").ToBool();
            if (ErrorToMail == true)
            {
                string SystemName = Mysoft.Util.Config.GetValue("SystemName");//系统名称
                MailHelper.Send("receivebug@Emaile.cn", SystemName + " - 发生异常", body.Replace("-", ""));
            }
        }
    }
}